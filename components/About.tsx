...
export default function About() {
  ...
  useEffect(() => {
    function updateScale() {
      ...
      const nextScale = Math.min(availableWidth / GRID_WIDTH, 1);
      setScale(nextScale);
    }
  ...
  return (
    <section className="w-full py-24">
      <div className="max-w-360 mx-auto">
        ...
        {/* Scaling wrapper — reserves the correct height so layout below doesn't collapse */}
        <div
          ref={wrapperRef}
        ...
        >
          {/* Fixed-size grid, scaled as one unit */}
          <div
            className="relative"
            style={{
              width: `${GRID_WIDTH}px`,
